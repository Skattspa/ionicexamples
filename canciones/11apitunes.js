    ...
    if (lista.length > 0){
        ...
        for(i = 0; i < lista.length; i++){
            ...
            array_fila = [
                        ...
                        "<input type='checkbox' name ='comprar' value='" + lista[i].trackId + "' onclick='listarCompra()'>"
                        ]
...
function listarCompra (e){
    console.log("creandolista");
    console.log("comprar"+ e.currentTarget);
    //var checked = document.getElementsByName("comprar").checked;
    //listaCompra objeto precio_pedido=suma de precios, lista_ids array
}
